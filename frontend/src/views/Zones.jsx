    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {zones.map((zone) => {
          ...
          return (
            <Card key={zone.id} className={`shadow-[0_8px_30px_rgb(0,0,0,0.02)] border border-transparent relative overflow-hidden transition-all duration-300 ${isWatering
              ...
              <CardHeader className="pb-3 z-10 relative">
                <div className="flex items-start justify-between">
                  ...
                  <div className={`text-[10px] px-2 py-0.5 rounded-full font-semibold flex items-center gap-1.5 border ${isWatering
              ...
              <CardContent className="flex flex-col gap-4 z-10 relative">
                ...
                <div className="grid grid-cols-2 gap-2 mt-1">
                  <button
                    ...
                    className={`py-2 rounded-lg font-bold text-xs flex items-center justify-center gap-1.5 border transition-all hover:-translate-y-0.5 active:translate-y-0 ${isWatering
