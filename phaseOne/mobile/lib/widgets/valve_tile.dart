    ...
    return Container(
      ...
      child: Material(
        ...
        child: ListTile(
          ...
          // 1. Title now ONLY contains the name, taking up the full available width
          title: Text(
            valve.name,
          ...
          // 2. Subtitle now holds the StatusChip, UID, and Time in the next row
          subtitle: Padding(
            padding: const EdgeInsets.only(top: 8), // Increased top padding slightly for breathing room
            child: Row(
              children: [
